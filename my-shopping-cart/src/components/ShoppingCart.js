...
const ShoppingCart = ({ cartData, updateCartData }) => {
  ...
  const handleQuantityChange = async (productId, action) => {
    try {
      await axios.post(`http://localhost:8000/public/api/update_quantitycart.php?product_id=${productId}&action=${action}`);
            ...
            <li key={item.product_id} className="flex items-center mb-10">
              ...
              <div className='ml-4 flex-grow'>
                ...
                <div className="flex items-center ml-auto"> 
                  ...
                  >
                    <img src={decreaseIcon} alt="Decrease Quantity" className="w-6 h-6" />
                  </button>
                  ...
                  <button
                    ...
                    className="bg-transparent border-none cursor-pointer"
                  >
                    <img src={increaseIcon} alt="Increase Quantity" className="w-6 h-6" />
                  </button>
